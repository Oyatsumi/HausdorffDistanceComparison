...
int main(int argc, char** argv)
{
	...
	//for (int k = 0; k < 1; k++){
		...
		//bool* img1B = img1.getBooleanLinearImage(0);
		//bool* img2B = img2.getBooleanLinearImage(0);

		
				
	//}

	//Volume img1 = Volume(4096,4096,1), img2 = Volume(4096,4096,1);
	...
	//img2.setVoxelValue(1, 4095,4095,0);
